...
```sh
grep -rl 'shentestboiler' ./ | xargs sed -i '' 's/shentestboiler/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with shentestboiler
...
Want to contribute? Ping us on `shentestboiler` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/shentestboiler.git
    cd shentestboiler
    ```
...
- [shentestboiler integration Documentation](https://docs.vuestorefront.io/shentestboiler)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `shentestboiler` channel on [our Discord](discord.vuestorefront.io).
